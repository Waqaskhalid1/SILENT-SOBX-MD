...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SILENT-SOBX-MD~fMBVFYLS#UDL_FiTNaYuhEM8h6FjgwfVhtMbSeOM7A-ao_2z53_g",
    ...
    BOT_NAME: process.env.BOT_NAME || "➺Habib_Mughal࿐",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү Habib Mughal YT`",
